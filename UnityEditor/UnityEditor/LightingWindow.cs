...
namespace UnityEditor
{
	...
	internal class LightingWindow : EditorWindow
	{
		...
		private void BakedGUI(SerializedObject so, SerializedProperty enableRealtimeGI, SerializedProperty enableBakedGI)
		{
			...
			SerializedProperty property4 = so.FindProperty("m_LightmapEditorSettings.m_TextureWidth");
			EditorGUI.indentLevel++;
			...
			EditorGUILayout.Slider(serializedProperty, 0f, 10f, LightingWindow.styles.AmbientOcclusion, new GUILayoutOption[0]);
			...
			EditorGUILayout.IntPopup(property4, this.kMaxAtlasSizeStrings, this.kMaxAtlasSizeValues, LightingWindow.styles.MaxAtlasSize, new GUILayoutOption[0]);
			EditorGUI.EndDisabledGroup();
			EditorGUI.indentLevel--;
		}
