...
namespace UnityEditor
{
	internal class AvatarMaskUtility
	{
		...
		{
			AvatarMaskUtility.<UpdateTransformMask>c__AnonStorey81 <UpdateTransformMask>c__AnonStorey = new AvatarMaskUtility.<UpdateTransformMask>c__AnonStorey81();
		...
		{
			AvatarMaskUtility.<TokeniseHumanTransformsPath>c__AnonStorey86 <TokeniseHumanTransformsPath>c__AnonStorey = new AvatarMaskUtility.<TokeniseHumanTransformsPath>c__AnonStorey86();
