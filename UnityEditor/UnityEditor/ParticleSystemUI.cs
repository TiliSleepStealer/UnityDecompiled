...
namespace UnityEditor
{
	internal class ParticleSystemUI
	{
		...
		{
			int num = 0;
			ModuleUI[] expr_09 = new ModuleUI[18];
			...
			expr_09[15] = new SubModuleUI(e, so, ParticleSystemUI.s_ModuleNames[num++]);
			expr_09[16] = new UVModuleUI(e, so, ParticleSystemUI.s_ModuleNames[num++]);
			return expr_09;
		}
