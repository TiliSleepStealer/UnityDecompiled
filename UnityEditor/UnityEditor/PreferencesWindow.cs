...
namespace UnityEditor
{
	internal class PreferencesWindow : EditorWindow
	{
		...
		private void Show2D()
		{
			...
			this.m_SpriteAtlasCacheSize = EditorGUILayout.IntSlider(this.m_SpriteAtlasCacheSize, PreferencesWindow.kMinSpriteCacheSizeInGigabytes, PreferencesWindow.kMaxSpriteCacheSizeInGigabytes, new GUILayoutOption[0]);
			GUILayout.EndHorizontal();
			if (EditorGUI.EndChangeCheck())
			{
				this.WritePreferences();
